...
VL_INLINE_OPT void SSC___024root___sequent__TOP__1(SSC___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    SSC__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    SSC___024root___sequent__TOP__1\n"); );
    // Init
...
VL_INLINE_OPT void SSC___024root___combo__TOP__5(SSC___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    SSC__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    SSC___024root___combo__TOP__5\n"); );
    // Body
...
void SSC___024root___eval(SSC___024root* vlSelf) {
    ...
    if (((IData)(vlSelf->original_clk) & (~ (IData)(vlSelf->__Vclklast__TOP__original_clk)))) {
        SSC___024root___sequent__TOP__1(vlSelf);
    }
    if (((~ (IData)(vlSelf->original_clk)) & (IData)(vlSelf->__Vclklast__TOP__original_clk))) {
        SSC___024root___sequent__TOP__2(vlSelf);
    }
    SSC___024root___combo__TOP__5(vlSelf);
    // Final

...
VL_ATTR_COLD void PPC___024root___settle__TOP__3(PPC___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    PPC__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    PPC___024root___settle__TOP__3\n"); );
    // Init
...
VL_ATTR_COLD void PPC___024root___eval_settle(PPC___024root* vlSelf) {
    ...
    // Body
    PPC___024root___settle__TOP__3(vlSelf);
}

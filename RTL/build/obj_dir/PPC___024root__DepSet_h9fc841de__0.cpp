...
VL_INLINE_OPT void PPC___024root___sequent__TOP__2(PPC___024root* vlSelf) {
    ...
    // Body
    vlSelf->PipelinedCore__DOT__SlowClockPPC__DOT__counter 
        = ((0xb71affU <= vlSelf->PipelinedCore__DOT__SlowClockPPC__DOT__counter)
            ? 0U : (0xffffffU & ((IData)(1U) + vlSelf->PipelinedCore__DOT__SlowClockPPC__DOT__counter)));
...
VL_INLINE_OPT void PPC___024root___sequent__TOP__4(PPC___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    PPC__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    PPC___024root___sequent__TOP__4\n"); );
    // Init
...
VL_INLINE_OPT void PPC___024root___sequent__TOP__5(PPC___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    PPC__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    PPC___024root___sequent__TOP__5\n"); );
    // Init
...
VL_INLINE_OPT void PPC___024root___multiclk__TOP__6(PPC___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    PPC__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    PPC___024root___multiclk__TOP__6\n"); );
    // Init
...
VL_INLINE_OPT void PPC___024root___combo__TOP__7(PPC___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    PPC__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    PPC___024root___combo__TOP__7\n"); );
    // Body
...
void PPC___024root___eval(PPC___024root* vlSelf) {
    ...
    if (((IData)(vlSelf->PipelinedCore__DOT__clk) & 
         (~ (IData)(vlSelf->__Vclklast__TOP__PipelinedCore__DOT__clk)))) {
        PPC___024root___sequent__TOP__4(vlSelf);
    }
    if (((~ (IData)(vlSelf->PipelinedCore__DOT__clk)) 
         & (IData)(vlSelf->__Vclklast__TOP__PipelinedCore__DOT__clk))) {
        PPC___024root___sequent__TOP__5(vlSelf);
    }
    if (((IData)(vlSelf->PipelinedCore__DOT__clk) ^ (IData)(vlSelf->__Vclklast__TOP__PipelinedCore__DOT__clk))) {
        PPC___024root___multiclk__TOP__6(vlSelf);
    }
    PPC___024root___combo__TOP__7(vlSelf);
    // Final
